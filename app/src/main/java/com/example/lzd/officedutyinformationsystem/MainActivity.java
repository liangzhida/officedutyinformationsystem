...
public class MainActivity extends AppCompatActivity{
    ...
    private String readPsw(String userName){
        ...
        SharedPreferences sharedPreferences= (SharedPreferences) getSharedPreferences("loginInfo", MODE_PRIVATE);
        //sp.getString() userName, "";
        return ((android.content.SharedPreferences) sharedPreferences).getString(userName , "");
    }
    /**
    ...
    private void saveLoginStatus(boolean status,String userName){
        ...
        SharedPreferences sp= (SharedPreferences) getSharedPreferences("loginInfo", MODE_PRIVATE);
        //获取编辑器
